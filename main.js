...
function setStyle(style){
    ...
    switch(style) {
        ...
        case 'lightMode':
            ...
            root.style.setProperty('--bg', 'rgba(255,255,255,1)')
            root.style.setProperty('--bgdark', 'rgba(180,180,180,1)')
            root.style.setProperty('--bglight', 'rgba(200,200,200,1)')
            root.style.setProperty('--highlight', 'rgba(128,110,189,1)');
            root.style.setProperty('--highlightdark', 'rgba(97,84,143,1)');
            break;
        case 'benStyle':
            document.body.classList.remove(...document.body.classList);
